...
<font color="red"><h3>!!! 建议先看C语言</h3></font>
...
> <font color="red">在 C++ 中，分号是语句结束符。也就是说，每个语句必须以分号结束。它表明一个逻辑实体的结束。</font>
...
<font color="blue">[ ]是Lambda引出符。编译器根据该引出符判断接下来的代码是否是Lambda函数。</font>
